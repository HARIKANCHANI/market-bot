...
MIDCAP_200 = [
    ...
    "CRISIL", "NLCINDIA", "SULA", "KALYANKJIL", "TATAELXSI", "QUESS",
...
SMALLCAP_300 = [
    ...
    "AMARA", "AMBER", "AMBUJACEM", "ANGELONE", "ANURAS", "APCOTEXIND",
